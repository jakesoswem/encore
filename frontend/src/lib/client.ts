...
export function Environment(name: string): BaseURL {
  return `https://${name}-encore-test-u4n2.encr.app`;
}
...
/**
 * Client is an API client for the encore-test-u4n2 Encore application.
 */
...
export namespace admin {
  ...
  export class ServiceClient {
     ...
     */
    public async GetAdminDashboardData(): Promise<DashboardData> {
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "encore-test-u4n2-Generated-TS-Client (Encore/v1.31.0)",
    };
